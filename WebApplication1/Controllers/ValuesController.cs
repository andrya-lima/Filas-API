...
namespace WebApplication1.Controllers
{
    public class ValuesController : ApiController
    {
        ...
        {
            //O emulador de armazenamento dá suporte a uma única conta fixa e uma chave de autenticação conhecida para a autenticação da Chave Compartilhada. Essa conta e a chave são as únicas credenciais de Chave Compartilhada permitidas para uso com o emulador de armazenamento. 
